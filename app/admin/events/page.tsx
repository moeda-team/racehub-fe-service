...
import type { ApiResponse, AdminEventPage, Event, EventStatus } from "@/lib/types.gen";
  ...
  return (
    <div className="rh-reveal">
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 20, flexWrap: "wrap" }}>
        {(["all", "published", "draft", "cancelled", "finished"] as const).map((f) => (
          <button
            key={f}
            type="button"
            ...
            style={{
              ...
              border: "1px solid",
              borderColor: filter === f ? "var(--color-flame)" : "var(--color-line-2)",
              background: filter === f ? "var(--color-flame)" : "var(--color-surface)",
        ...
        <>
                ...
                <tbody>
                  {events.map((ev) => (
                    <tr key={ev.id} style={{ cursor: "pointer" }}>
                      ...
                      <td style={{ fontFamily: "var(--font-mono)", fontSize: 13, whiteSpace: "nowrap" }}>
          ...
          {totalPages > 1 && (
            <div style={{ display: "flex", justifyContent: "center", gap: 8, marginTop: 20 }}>
              ...
              <span style={{ display: "flex", alignItems: "center", fontSize: 13, color: "var(--color-ink-3)", padding: "0 12px" }}>
                {page} / {totalPages}
              </span>
              <Button
                variant="ghost"
